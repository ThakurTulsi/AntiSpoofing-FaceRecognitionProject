...
#--------------------------------------blink check-------------------------------------------------
    ...
    def submit_action(self):
        ...
        if self.id in ids:
            ...
            users_info_txt_path = f"{self.user_dir}/User_{self.id}/user_info.txt"
                
            with open (users_info_txt_path,'r') as f:
                lines = f.readlines()
            ...
            if blink_detected:
                ...
                if name in ['unknown_person','no_persons_found']:
                    ...
                    self.send_email(email, 'Attendance Confirmation',
                    f"Dear {name}, your attendance has been recorded at {datetime.datetime.now()}.Your total attendance is:{line_count}")
